 ...
 */
[_RAISE] = {
  {KC_TILD, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_BSPC},
 ...
 */
[_NAV] = {
  {_______, XXXXXXX, M(0),    KC_UP,   M(1),    XXXXXXX, XXXXXXX, KC_PSCR, KC_SLCK, KC_PAUS, XXXXXXX, _______},
